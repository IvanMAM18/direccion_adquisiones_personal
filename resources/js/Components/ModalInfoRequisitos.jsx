export default function ModalInfoRequisitos({modo, tipo}) {
    return (
            <div className="absolute shadow-lg py-8 px-16 z-20 w-full h-[35vw] overflow-y-auto bg-white border border-orange-300 rounded-2xl text-rose-950 font-bold text-justify">
                ...
                </div>
                {
                    modo === 'actualizacion' ? (
                        ...
                        <div className='text-sm font-medium'>
                            ...
                            <p className="my-2 font-bold">
                                SIEMPRE Y CUANDO SE CUENTE CON 1 AÑO O MAS RESGISTROS ANTE EL SAT Y NO SEA SERVIDOR PUBLICO (ART. 34 Y 61 DE LA LEY DE ADQUISIONES, ARRENDAMIENTOS T SERVICIOS DEL ESTADO DE BAJA CALIFORNIA SUR).
                            </p>
                            ...
                            <p className="my-2">
                                8. DOCUMENTACION MANIFESTANDO SU CLABE INTERBANCARIA, CUENTA BANCARIA, NOMBRE COMPLETO DEL CEUNTAHABIENTE Y NOMBRE COMPLETO DEL BANCO. (EN CUMPLIMIENTO CON EL ART. 67 DE LA LEY GENERAL DE CONTABILIDAD GUBERNAMENTRAL.) DEBIDAMENTE VALIDADA POR EL REPRESENTANTE LEGAL.
                            </p>
                            ...
                            <p className="my-2">
                                6. DOCUMENTO MANIFESTANDO SU CLABE INTERBANCARIA, CUENTA BANCARIA, NOMBRE COMPLETO DEL CUENTAHABIENTE Y NOMBRE COMPLETO DEL BANCO. (EN CUMPLIMIENTO CON EL ART. 67 DE LA LEY GENERAL DE CONTABILIDAD GUBERNAMENTAL). DEBIDAMENTE VALIDADA POR EL REPRESENTANTE LEGAL.
                            </p>
                            <p className="my-2 font-bold text-center">
