    ...
    return (
            <>
                <div className={`relative mt-4 pb-10 mx-auto`}>
                    ...
                    <div className={`text-pink-950 w-full mt-8 ${isSmallScreen ? ('text-xl text-center') : ('text-2xl')} font-bold`}>
                        FORMATO DE ALTA
                    </div>
                    <a href='alta/moral'>
                        <div className={`relative my-6 px-10 bg-rose-950  text-orange-300 rounded-2xl opacity-85 cursor-pointer hover:opacity-100 hover:text-white hover:shadow-xl hover:drop-shadow-lg`}>
                            <div className={`z-10 py-4 ${isSmallScreen ?('mx-auto'):('flex')} items-center`}>
                                <svg className={`h-24 w-24 ${isSmallScreen ?('w-full'):('')}`} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />  <line x1="9" y1="9" x2="10" y2="9" />  <line x1="9" y1="13" x2="15" y2="13" />  
                                    <line x1="9" y1="17" x2="15" y2="17" />
                    ...
                    <a href='alta/fisica'>
                        <div className={`relative my-4 px-10 bg-rose-950  text-orange-300 rounded-2xl opacity-85 cursor-pointer hover:opacity-100 hover:text-white hover:shadow-xl hover:drop-shadow-lg`}>
                            <div className={`z-10 py-4 ${isSmallScreen ?('mx-auto'):('flex')} items-center`}>
                                <svg className={`h-24 w-24 ${isSmallScreen ?('w-full'):('')}`} width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />  <line x1="9" y1="9" x2="10" y2="9" />  <line x1="9" y1="13" x2="15" y2="13" />  
                                    <line x1="9" y1="17" x2="15" y2="17" />
