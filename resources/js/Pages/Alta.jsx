...
export default function Alta({ auth , tipo}) {
    return (
        <>
            <AuthenticatedLayout
                user={auth.user}
                header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">FORMATO DE ALTA PARA PERSONAS {tipo === 'moral' ?('MORALES'):('FISICAS')}</h2>}
            >
                <Head title="Inicio"/>
